...
public class MatchResourceIntTest {
    ...
    private static final Long DEFAULT_CANDIDATE = 1L;
    private static final Long UPDATED_CANDIDATE = 2L;

    private static final Boolean DEFAULT_CANDIDATE_BOOL = false;
    private static final Boolean UPDATED_CANDIDATE_BOOL = true;

    private static final Long DEFAULT_PROJECT = 1L;
    private static final Long UPDATED_PROJECT = 2L;

    private static final Boolean DEFAULT_PROJECT_BOOL = false;
    private static final Boolean UPDATED_PROJECT_BOOL = true;
    ...
    public static Match createEntity(EntityManager em) {
        Match match = new Match()
            ...
            .candidateBool(DEFAULT_CANDIDATE_BOOL)
            .project(DEFAULT_PROJECT)
            .projectBool(DEFAULT_PROJECT_BOOL);
        return match;
    }
    ...
    public void createMatch() throws Exception {
        ...
        assertThat(testMatch.getCandidate()).isEqualTo(DEFAULT_CANDIDATE);
        assertThat(testMatch.isCandidateBool()).isEqualTo(DEFAULT_CANDIDATE_BOOL);
        assertThat(testMatch.getProject()).isEqualTo(DEFAULT_PROJECT);
        assertThat(testMatch.isProjectBool()).isEqualTo(DEFAULT_PROJECT_BOOL);
    }
    ...
    public void getAllMatches() throws Exception {
        ...
        restMatchMockMvc.perform(get("/api/matches?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].candidate").value(hasItem(DEFAULT_CANDIDATE.intValue())))
            .andExpect(jsonPath("$.[*].candidateBool").value(hasItem(DEFAULT_CANDIDATE_BOOL.booleanValue())))
            .andExpect(jsonPath("$.[*].project").value(hasItem(DEFAULT_PROJECT.intValue())))
            .andExpect(jsonPath("$.[*].projectBool").value(hasItem(DEFAULT_PROJECT_BOOL.booleanValue())));
    }
    ...
    public void getMatch() throws Exception {
        ...
        restMatchMockMvc.perform(get("/api/matches/{id}", match.getId()))
            ...
            .andExpect(jsonPath("$.candidate").value(DEFAULT_CANDIDATE.intValue()))
            .andExpect(jsonPath("$.candidateBool").value(DEFAULT_CANDIDATE_BOOL.booleanValue()))
            .andExpect(jsonPath("$.project").value(DEFAULT_PROJECT.intValue()))
            .andExpect(jsonPath("$.projectBool").value(DEFAULT_PROJECT_BOOL.booleanValue()));
    }
    ...
    public void updateMatch() throws Exception {
        ...
        updatedMatch
            ...
            .candidateBool(UPDATED_CANDIDATE_BOOL)
            .project(UPDATED_PROJECT)
            .projectBool(UPDATED_PROJECT_BOOL);
        ...
        Match testMatch = matchList.get(matchList.size() - 1);
        assertThat(testMatch.getCandidate()).isEqualTo(UPDATED_CANDIDATE);
        assertThat(testMatch.isCandidateBool()).isEqualTo(UPDATED_CANDIDATE_BOOL);
        assertThat(testMatch.getProject()).isEqualTo(UPDATED_PROJECT);
        assertThat(testMatch.isProjectBool()).isEqualTo(UPDATED_PROJECT_BOOL);
    }
