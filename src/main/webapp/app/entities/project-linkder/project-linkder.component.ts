...
@Component({
    selector: 'jhi-project-linkder',
    templateUrl: './project-linkder.component.html'
})
export class ProjectLinkderComponent implements OnInit, OnDestroy {
    ...
    trackId(index: number, item: IProjectLinkder) {
        return item.id;
    }
